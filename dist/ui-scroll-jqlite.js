...
exports['default'] = jqLiteExtrasRegister;

function jqLiteExtrasRegister(element) {
...
var _modulesJqliteExtrasRegister = require('./modules/jqlite-extras-register');

var _modulesJqliteExtrasRegister2 = _interopRequireDefault(_modulesJqliteExtrasRegister);

angular.module('ui.scroll.jqlite', ['ui.scroll']).service('jqLiteExtras', function () {
  return {
    registerFor: _modulesJqliteExtrasRegister2['default']
  };
...
},{'./modules/jqlite-extras-register':1}]},{},[2]);
}());