...
var jqLiteExtras = ['$log', '$window', function (console, window) {
	return {
...
exports.jqLiteExtras = jqLiteExtras;

},{}],2:[function(require,module,exports){
'use strict';

var _modulesUiScrollJqliteJs = require('./modules/ui-scroll-jqlite.js');

angular.module('ui.scroll.jqlite', ['ui.scroll']).service('jqLiteExtras', _modulesUiScrollJqliteJs.jqLiteExtras).run(['$log', '$window', 'jqLiteExtras', function (console, window, jqLiteExtras) {
	if (!window.jQuery) {
		return jqLiteExtras.registerFor(angular.element);
	}
}]);

},{'./modules/ui-scroll-jqlite.js':1}]},{},[2]);
}());