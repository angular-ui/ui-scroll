...
exports.ElementRoutines = ElementRoutines;
...
function Viewport(elementRoutines, buffer, cache, element, controllers, attrs) {
	var PADDING_MIN = 0.3;
...
exports.__esModule = true;
exports.uiScrollViewport = uiScrollViewport;
...
var _miscCacheJs = require('./misc/cache.js');
...
var uiScroll = ['$log', '$injector', '$rootScope', '$timeout', '$q', '$parse', function (console, $injector, $rootScope, $timeout, $q, $parse) {
	...
	function compile(elementTemplate, attr, compileLinker) {
		...
		return function link($scope, element, $attr, controllers, linker) {
			...
			var pending = [];
			var cache = new _miscCacheJs.Cache();
			var elementRoutines = new _miscElementRoutinesJs.ElementRoutines($injector);
			var buffer = new _miscBufferJs.Buffer(elementRoutines, itemName, $scope, linker, bufferSize);
			var viewport = new _miscViewportJs.Viewport(elementRoutines, buffer, cache, element, controllers, $attr);
			var adapter = new _miscAdapterJs.Adapter($parse, $attr, viewport, buffer, function () {
...
},{'./misc/adapter.js':1,'./misc/buffer.js':2,'./misc/cache.js':3,'./misc/elementRoutines.js':4,'./misc/viewport.js':5}],8:[function(require,module,exports){
/*!
...
angular.module('ui.scroll', []).directive('uiScrollViewport', _modulesUiScrollViewportJs.uiScrollViewport).directive('uiScroll', _modulesUiScrollJs.uiScroll);
